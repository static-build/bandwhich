...
prepare(){
    if [ -d code ]; then
        echo "Already exists"
        git subtree pull --prefix code https://github.com/imsnif/bandwhich.git 0.20.0 --squash
    else
        git subtree add --prefix code https://github.com/imsnif/bandwhich.git 0.20.0 --squash
    fi
}
